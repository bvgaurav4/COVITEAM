...
function Creating() {
    ...
    async function handlesubmission(event: React.FormEvent) {
        ...
        const response = await fetch(`${endpoints}/newuser`, {
          ...
          body: JSON.stringify({ SRN,email,name,department_id,password }),
        });
    ...
    <Paper withBorder shadow='mb' p={30} mt={30} radius="md">  
      <Stepper active={active} onStepClick={setActive} breakpoint="sm">
        <Stepper.Step label="First step" description="Create an account">
            ...
            <TextInput label="department_id" placeholder="description" required value={SRN} onChange={(e)=>setdepartment_id(e.currentTarget.value)} />       
